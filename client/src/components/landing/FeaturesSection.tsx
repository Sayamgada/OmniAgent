...
const FeaturesSection = () => (
  <section id="features" className="py-28 bg-background text-foreground border-t border-border relative">
    <div className="container mx-auto px-4 sm:px-6">
      ...
      >
        ...
        <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-foreground mb-4 leading-tight">
          Built For <span className="bg-gradient-to-r from-sky-500 to-cyan-500 bg-clip-text text-transparent">Developer-Grade Automation</span>
        </h2>
        ...
        {capabilities.map((cap, i) => {
          ...
          return (
            <motion.div
              ...
              className="group rounded-2xl border border-border bg-card p-6 hover:border-primary/50 hover:shadow-lg transition-all flex flex-col justify-between shadow-sm"
            >
              <div>
                ...
                <h3 className="font-bold text-base text-foreground mb-2">{cap.title}</h3>
              ...
              <div className="mt-5 pt-3.5 border-t border-border/60 flex items-center justify-between text-[11px] font-mono text-muted-foreground">
                <span className="text-primary font-semibold">Core Capability</span>
